...
export const CATALOGUE_SOURCES = [
  ...
  {
    slug: "firms",
    nom: "NASA FIRMS — anomalies thermiques VIIRS",
    url: "https://firms.modaps.eosdis.nasa.gov/",
    licence: "NASA Open Data / FIRMS Terms of Use",
  ...
  {
    slug: "fire_risk_gard",
    nom: "Prévention incendie Gard — risque quotidien par massif",
    url: "https://www.risque-prevention-incendie.fr/gard/",
    licence: "Information publique — Préfecture du Gard",
    attribution: "© Prévention incendie Gard",
    frequence: "quotidienne vers 18 h",
    theme: "risques",
    job: "fire_risk_gard",
  },
  {
