...
export const WEATHER_NATURES = ["station_observation", "model_at_point", "calculated_estimate", "fallback", "unavailable"] as const;
...
export interface WeatherTemperatureResponse {
  ...
  temperature: { valueCelsius: number; nature: "station_observation" | "model_at_point"; referenceTime: string; retrievedAt: string; ageMinutes: number | null; stale: boolean; quality: "good" | "stale" };
  method: { id: "meteo-v2-temperature"; version: "1"; stationSelectionPolicyVersion: "1" };
