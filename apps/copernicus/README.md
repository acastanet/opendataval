...
L’empreinte climatique historique est désormais isolée dans le dépôt autonome
[`poc/climat/empreinte-climatique`](../../poc/climat/empreinte-climatique/README.md).
Ce dossier contient sa collecte CDS paramétrable, son moteur, ses tests et ses rendus. Son
branchement au job de fabrication des dalles reste volontairement séparé de cette application
afin de ne jamais exposer un appel distant au chargement d'une page publique.
