...
<style>
  .etat { padding: 2rem 0; color: var(--texte-secondaire); font-weight: 600; } .erreur { color: #9f2637; }.resume { display:grid; grid-template-columns:repeat(2,minmax(0,1fr)); gap:1rem; }.resume article,.exploration,.dernieres,.liste,.methodologie { border:1px solid var(--bordure-forte); border-radius:8px; padding:clamp(1rem,3vw,1.6rem); background:var(--surface-plate); box-shadow:0 2px 8px rgba(23,56,75,.08); }.resume p,.resume span,.eyebrow,.legende { margin:0; color:var(--texte-secondaire); }.resume p,.eyebrow { color:var(--surface-sombre); font-size:.74rem; font-weight:900; letter-spacing:.1em; text-transform:uppercase; }.resume strong { display:block; margin-top:.4rem; color:var(--texte-principal); font-family:var(--font-display); font-size:2.9rem; line-height:1; }.resume strong.date { font-family:inherit; font-size:1.25rem; line-height:1.25; }.resume span { display:block; margin-top:.45rem; font-size:.88rem; font-weight:600; line-height:1.4; }.statut-source.fraiche { color:#18794e; }.statut-source.ancienne { color:#8a5a00; }.statut-source.indisponible { color:#9f2637; }.repartition { display:grid; grid-column:1/-1; grid-template-columns:repeat(3,minmax(0,1fr)); gap:.65rem; margin:0; }.repartition div { padding:.7rem; border:1px solid var(--bordure-forte); border-radius:4px; background:var(--surface-fond); }.repartition dt { color:var(--texte-secondaire); font-size:.8rem; font-weight:800; }.repartition dd { margin:.2rem 0 0; color:var(--texte-principal); font-family:var(--font-display); font-size:1.65rem; font-weight:800; }.exploration,.dernieres,.liste,.methodologie { margin-top:1.25rem; }.titre-ligne { display:flex; align-items:center; justify-content:space-between; gap:1rem; margin-bottom:1rem; }.titre-ligne h2,.dernieres h2,.liste h2,.methodologie h2 { margin:.3rem 0 0; color:var(--texte-principal); font-family:var(--font-display); font-size:1.6rem; }.periodes { display:flex; gap:.25rem; padding:.25rem; border:1px solid var(--bordure-forte); border-radius:6px; background:var(--surface-fond); }.periodes button { min-height:40px; border:1px solid transparent; border-radius:4px; padding:.45rem .8rem; color:var(--texte-principal); background:transparent; font:inherit; font-weight:800; cursor:pointer; }.periodes button.actif { color:#ffffff; border-color:var(--surface-sombre); background:var(--surface-sombre); }.periodes button:disabled { cursor:wait; opacity:.7; }.periodes button:focus-visible { outline:3px solid #2472a4; outline-offset:2px; }.alerte-technique { grid-column:1/-1; margin:.8rem 0; padding:.75rem .85rem; border-left:5px solid #a56700; border-radius:4px; color:var(--texte-principal)!important; background:#fff8e6; font-weight:750!important; line-height:1.5; text-transform:none!important; letter-spacing:normal!important; }.alerte-technique.erreur { border-left-color:#ad2434; background:#fff0f2; }.carte-wrap { position:relative; }.carte { height:clamp(330px,58vw,580px); border:1px solid var(--bordure-forte); border-radius:5px; overflow:hidden; }.legende { display:flex; flex-wrap:wrap; gap:.65rem 1rem; margin-top:.75rem; padding:0; list-style:none; font-size:.86rem; font-weight:700; }.legende span { display:inline-block; width:.75rem; height:.75rem; vertical-align:-.05rem; border:1px solid #17242c; border-radius:50%; }.coeur{ background:#bb2435; }.proche{ background:#e67524; }.veille{ background:#d69d00; }.dernieres > p,.methodologie > p { max-width:75ch; margin:.75rem 0 0; color:var(--texte-secondaire); font-weight:600; line-height:1.5; }.dernieres .absence-detection { color:var(--texte-principal); }.liste p { color:var(--texte-principal); font-weight:600; line-height:1.55; }.liste ol,.historique { display:grid; gap:.75rem; padding-left:1.2rem; }.liste li,.historique li { padding:.75rem; border:1px solid var(--bordure-forte); border-radius:4px; background:var(--surface-fond); }.liste li strong,.historique li strong { color:var(--texte-principal); }.liste li span,.historique li span { display:block; margin-top:.2rem; color:var(--texte-secondaire); font-size:.9rem; font-weight:600; }.liste li a { display:inline-block; margin-top:.45rem; color:var(--surface-sombre); font-size:.86rem; font-weight:850; }.methodologie ul { line-height:1.8; }.methodologie a { color:var(--surface-sombre); font-weight:800; }.avertissement { max-width:75ch; margin:1.25rem auto 0; color:var(--texte-secondaire); font-size:.86rem; font-weight:600; line-height:1.5; text-align:center; }
